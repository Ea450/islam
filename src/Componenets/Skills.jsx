          ...
          <ul>
            {skills.map((skill, index) => (
              <li
                ...
                style={{ transform: `rotate(${skill.id * 45}deg)` }}
              >
                <div
                  className={`hover:*:opacity-100 relative top-10 flex w-[3.2rem] h-[3.2rem] bg-n-7 border border-[#444] rounded-full hover:-top-0.25 hover:not-first:opacity-100`}
                  id="li-img"
                  style={{ transform: `rotate(-${skill.id * 45}deg)` }}
                >
                  <img
                    ...
                    width={skill.width}
                    height={skill.height}
                    className="rounded-full hover:w-[4rem]"
                  />
                  <div className=" text-gray-300 absolute -top-12 text-[15px] opacity-0">
                    {skill.title}
                  </div>
                </div>
              </li>
